...
void collide (const string& filename = "./data.root",
    ...
    save->Branch("NColl", &data.nCol, "NColl/I");
    save->Branch("NPart", &data.nPart, "NPart/I");
    save->Branch("Dist", &data.d, "Dist/D");
    save->Branch("xCol", &data.xCol);
    save->Branch("yCol", &data.yCol);
